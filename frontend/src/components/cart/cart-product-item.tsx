  ...
  return(
    <div className="flex items-center p-6 gap-4 md:gap-8 border-0 md:border-b border-gray-200">
      ...
      <div className="flex-1 flex flex-col md:flex-row justify-between md:items-center">
        ...
        <div>
          <div className="w-30 flex border border-gray-200 rounded-sm text-center text-gray-500">
            <div onClick={handleMinus} className="size-10 cursor-pointer flex justify-center items-center text-2xl">
              -
            </div>
            <div className="size-10 border-x border-gray-200 flex justify-center items-center text-lg">
              {item.quantity}
            </div>
            <div onClick={handlePlus} className="size-10 cursor-pointer flex justify-center items-center text-2xl">
              +
            </div>
          </div>
        </div>
      ...
      <div className="w-24 md:w-40 flex flex-col md:flex-row justify-between items-end md:items-center">
        <div className="text-blue-600 text-lg">{item.product.price.toFixed(2)}</div>
        <div>
          <div onClick={handleRemove} className="cursor-pointer size-12 border border-gray-200 flex justify-center items-center rounded-sm">
            <Image 
